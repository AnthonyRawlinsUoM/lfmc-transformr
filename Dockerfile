...
RUN R -e 'install.packages(c("snowfall", "httr", "xml2", "maptools", "stringr", "Rook", "rjson", "rgeos", "raster", "ncdf4", "jsonlite", "geojsonio", "rmapshaper", "spdplyr", "rgdal", "curl", "codetools", "jqr", "V8", "httr", "geojsonlint", "gdalUtils"))'
